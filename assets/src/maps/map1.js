...
const map1 = {
  ...
  '-2|8': { type: 'water' },
  ...area([-1, 1], [8, 8], { type: 'water', config: { animation: 'one-side', rotation: Math.PI } }),
  '2|8': { type: 'water' },

  '0|7': { type: 'path', config: { type: 'full' } },
  '2|7': { type: 'water', config: { animation: 'one-side', rotation: Math.PI / 2, wall: [ 'left' ] } },
  '1|7': { type: 'path', config: { type: 'full' } },
  '-1|7': { type: 'path', config: { type: 'full' } },
  '-2|7': { type: 'water', config: { animation: 'one-side', rotation: -Math.PI / 2 } },
  ...
  ...area([-8, -3], [4, 4], { type: 'water', config: { animation: 'one-side', rotation: Math.PI } }),
  '-2|4': { type: 'water' },
  '-1|4': { type: 'water', config: { animation: 'corner', wall: [ 'top' ] } },
  '0|4': { type: 'path', config: { type: 'full' } },
  '1|4': { type: 'water', config: { animation: 'corner', wall: [ 'left', 'top' ], rotation: Math.PI / 2 } },
  '2|4': { type: 'water' },

  ...area([-8, -4], [3, 3], { type: 'grass' }),
  '-3|3': { type: 'cliff', config: [{ position: 'right', height: 1 }] },
  '-2|3': { type: 'water', config: { animation: 'corner', wall: [ 'left' ], rotation: Math.PI } },
  '-1|3': { type: 'water', config: { animation: 'one-side', rotation: - Math.PI / 2 } },
  '0|3': { type: 'path', config: { type: 'full' } },
  '1|3': { type: 'water', config: { animation: 'one-side', wall: [ 'left' ], rotation: Math.PI / 2 } },
  '2|3': { type: 'water' },
  ...
  '-1|2': { type: 'water', config: { animation: 'three-side', wall: [ 'left' ], rotation: - Math.PI / 2 } },
  '0|2': { type: 'path', config: { type: 'full' } },
  '1|2': { type: 'water', config: { animation: 'corner', wall: [ 'left' ], rotation: Math.PI } },
  '2|2': { type: 'water', config: { animation: 'one-side', rotation: Math.PI } },
  ...area([3, 6], [2, 2], { type: 'water' }),
  '7|2': { type: 'water', config: { animation: 'one-side', rotation: Math.PI } },
  '8|2': { type: 'water', config: { animation: 'corner', rotation: - Math.PI / 2 } },
  ...
  '3|1': { type: 'water', config: { animation: 'one-side', wall: [ 'left' ], rotation: Math.PI / 2 } },
  '4|1': { type: 'water' },
  '5|1': { type: 'water' },
  '6|1': { type: 'water', config: { animation: 'corner', rotation: - Math.PI / 2 } },
  '7|1': { type: 'grass' },
  '8|1': { type: 'grass' },

  '-8|0': { type: 'water', config: { animation: 'one-side', wall: [ 'top' ] } },
  '-7|0': { type: 'water', config: { animation: 'one-side', wall: [ 'top' ] } },
  '-6|0': { type: 'water', config: { animation: 'corner', wall: [ 'top' ] } },
  ...
  '0|0': { type: 'path' },
  '1|0': { type: 'grass' },
  '2|0': { type: 'water', config: { animation: 'three-side', wall: [ 'left', 'top' ], rotation: Math.PI } },
  '3|0': { type: 'water' },
  '4|0': { type: 'water' },
  '5|0': { type: 'water', config: { animation: 'corner', rotation: - Math.PI / 2 } },
  '6|0': { type: 'grass' },
  '7|0': { type: 'grass' },
  '8|0': { type: 'grass' },

  '-8|-1': { type: 'water', config: { animation: 'one-side', rotation: Math.PI } },
  '-7|-1': { type: 'water', config: { animation: 'one-side', rotation: Math.PI } },
  '-6|-1': { type: 'water' },
  '-5|-1': { type: 'water', config: { animation: 'one-side', wall: [ 'top' ] } },
  '-4|-1': { type: 'water', config: { animation: 'one-side', wall: [ 'top' ] } },
  '-3|-1': { type: 'water', config: { animation: 'one-side', wall: [ 'top' ] } },
  ...
  '3|-1': { type: 'water', config: { animation: 'one-side', wall: [ 'left' ], rotation: Math.PI / 2 } },
  '4|-1': { type: 'water', config: { animation: 'one-side', rotation: - Math.PI / 2 } },
  '5|-1': { type: 'grass' },
  '6|-1': { type: 'grass' },
  '7|-1': { type: 'grass' },
  '8|-1': { type: 'grass' },
  ...
  '-8|-2': { type: 'grass' },
  '-7|-2': { type: 'grass' },
  '-6|-2': { type: 'water', config: { animation: 'corner', wall: [ 'left' ], rotation: Math.PI } },
  '-5|-2': { type: 'water' },
  '-4|-2': { type: 'water' },
  '-3|-2': { type: 'water' },
  '-2|-2': { type: 'water', config: { animation: 'one-side', rotation: Math.PI } },
  '-1|-2': { type: 'water', config: { animation: 'both-side', wall: [ 'top' ] } },
  '0|-2': { type: 'path', config: { type: 'full', wall: [ 'right', 'left' ] } },
  '1|-2': { type: 'water', config: { animation: 'both-side', wall: [ 'top' ] } },
  '2|-2': { type: 'water', config: { animation: 'one-side', wall: [ 'top' ] } },
  '3|-2': { type: 'water' },
  '4|-2': { type: 'water', config: { animation: 'corner', rotation: - Math.PI / 2  } },
  '5|-2': { type: 'grass' },
  '6|-2': { type: 'water', config: { animation: 'corner', rotation: Math.PI / 2, wall: [ 'left', 'top' ]  } },
  '7|-2': { type: 'water', config: { animation: 'both-side', wall: [ 'top' ] }  },
  '8|-2': { type: 'grass' },
  ...
  '-4|-3': { type: 'water', config: { animation: 'one-side', rotation: Math.PI / 2, wall: [ 'left' ] } },
  '-3|-3': { type: 'water', config: { animation: 'one-side', rotation: - Math.PI / 2 } },
  '-2|-3': { type: 'grass' },
  '-1|-3': { type: 'grass' },
  '0|-3': { type: 'path' },
  '1|-3': { type: 'tree', config: { type: 1 } },
  '2|-3': { type: 'water', config: { animation: 'corner', rotation: Math.PI, wall: [ 'left' ] } },
  '3|-3': { type: 'water', config: { animation: 'one-side', rotation: - Math.PI / 2 } },
  '4|-3': { type: 'tree', config: { type: 4 } },
  '5|-3': { type: 'grass' },
  '6|-3': { type: 'water', config: { animation: 'both-side', wall: [ 'left' ], rotation: - Math.PI / 2 } },
  '7|-3': { type: 'grass' },
  '8|-3': { type: 'grass' },
  ...
  '-4|-4': { type: 'water', config: { animation: 'one-side', rotation: Math.PI / 2, wall: [ 'left' ] } },
  ...
  '1|-4': { type: 'grass' },
  '2|-4': { type: 'grass' },
  '3|-4': { type: 'water', config: { animation: 'one-side', rotation: Math.PI / 2, wall: [ 'left' ] } },
  '4|-4': { type: 'water', config: { animation: 'one-side', wall: [ 'top' ] } },
  '5|-4': { type: 'water', config: { animation: 'one-side', wall: [ 'top' ] } },
  '6|-4': { type: 'water', config: { animation: 'one-side', rotation: -Math.PI / 2 } },
  '7|-4': { type: 'grass' },
  '8|-4': { type: 'grass' },
  ...
  '-4|-5': { type: 'water', config: { animation: 'both-side', rotation: Math.PI / 2, wall: [ 'left' ] } },
  ...
  '3|-5': { type: 'water', config: { animation: 'corner', rotation: Math.PI, wall: [ 'left' ] } },
  '4|-5': { type: 'water', config: { animation: 'one-side', rotation: Math.PI } },
  '5|-5': { type: 'water' },
  '6|-5': { type: 'water' },
  '7|-5': { type: 'water', config: { animation: 'corner', wall: [ 'top' ] } },
  '8|-5': { type: 'grass' },
  ...
  '-4|-6': { type: 'water', config: { animation: 'one-side', rotation: Math.PI / 2, wall: [ 'left' ] } },
  '-3|-6': { type: 'water', config: { animation: 'corner', wall: [ 'top' ] } },
  ...
  '4|-6': { type: 'grass'},
  '5|-6': { type: 'water', config: { animation: 'corner', rotation: Math.PI } },
  '6|-6': { type: 'water', config: { animation: 'one-side', rotation: Math.PI } },
  '7|-6': { type: 'water', config: { animation: 'corner', rotation: - Math.PI / 2 } },
  '8|-6': { type: 'grass' },
  ...
  '-4|-7': { type: 'water' },
  '-3|-7': { type: 'water' },
  '-2|-7': { type: 'water', config: { animation: 'both-side', wall: [ 'top' ] } },
  '-1|-7': { type: 'water', config: { animation: 'three-side', wall: [ 'top' ] } },
  '0|-7': { type: 'path' },
  '1|-7': { type: 'cliff' },
  '2|-7': { type: 'cliff' },
