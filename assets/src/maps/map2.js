const map2 = {
  ...
  '-2|-1': { type: 'water', config: { animation: 'corner' } },
  ...
  '2|-2': { type: 'grass' },
  '1|-2': { type: 'water', config: { animation: 'three-side', rotation: Math.PI / 2 } },
  '0|-2': { type: 'path' },
  '-1|-2': { type: 'water', config: { animation: 'corner' } },
  '-2|-2': { type: 'water' },

  '0|-3': { type: 'path' },
  '2|-3': { type: 'water', config: { animation: 'one-side' } },
  '1|-3': { type: 'water', config: { animation: 'corner', rotation: Math.PI } },
  ...
  '0|-7': { type: 'water', config: { animation: 'one-side'} },
  '2|-7': { type: 'water' },
  '1|-7': { type: 'water', config: { animation: 'one-side' } },
  '-1|-7': { type: 'water', config: { animation: 'one-side' } },
  '-2|-7': { type: 'water' },
}
